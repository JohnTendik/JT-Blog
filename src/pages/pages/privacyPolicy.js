...
function MasterRaiderPrivacyPolicy(props) {
  const { title: siteTitle, subtitle: siteSubtitle } = useSiteMetadata();
  const metaDescription = siteSubtitle;
  const pageTitle = 'Master Raider Privacy Policy';
    ...
    <Layout title={`${pageTitle} - ${siteTitle}`} description={metaDescription}>
      ...
      <Page title={pageTitle}>
        <strong>Privacy Policy</strong> <p>
                  JT built the PoGo Master Raider app as
                  an Ad Supported app. This SERVICE is provided by
                  JT at no cost and is intended for use as
                  is.
                </p> <p>
                  ...
                  PoGo Master Raider unless otherwise defined in this Privacy Policy.
                  ...
                  Privacy Policy, do not hesitate to contact me at thenerdjt@gmail.com.
                </p>
      </Page>
    </Layout>
  );
}
export default MasterRaiderPrivacyPolicy